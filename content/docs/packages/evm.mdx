...
It gives you end-to-end `type safety` from your ABI — `function names`, `arguments`, `return values`, and `events` are all inferred automatically without manual typing.
