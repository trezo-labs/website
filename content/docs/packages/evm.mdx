---
title: Trezo EVM
description: Install and configure the Trezo EVM toolkit to interact with smart contracts and wallets in a Next.js application.
---
...
```tsx title="lib/evm.config.ts" showLineNumbers
"use client";
