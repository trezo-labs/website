...
> To submit a new template to the CLI, go to [**New CLI Template**](/cli/templates/new) page. Your template will be reviewed and approved before becoming available for others to use, and it **must** include at least one Trezo package.
