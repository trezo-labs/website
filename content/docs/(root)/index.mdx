...
Trezo is organized as a collection of focused packages rather than a single monolithic SDK. Each blockchain integration lives in its own package, such as:
...
Install only what you need. Projects stay lightweight and each package handles its own dependencies.
